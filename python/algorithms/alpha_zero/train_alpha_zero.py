...
from python.algorithms.alpha_zero.alpha_zero_data_generator import DataGenerator
from python.algorithms.alpha_zero.alpha_zero_learner import Learner
from python.algorithms.alpha_zero.alpha_zero_replay_buffer import ReplayBuffer
