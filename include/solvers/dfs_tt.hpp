#ifndef DEPTH_FIRST_SEARCH_TRANSPOSITIONS_HPP
#define DEPTH_FIRST_SEARCH_TRANSPOSITIONS_HPP
...
// struct Node {
//     std::array<State::BBType, 2> state;
// };
...
template <typename Game> std::int8_t Solver<Game>::DFS() {
    this->num_expansions++;
    Outcomes outcome;
